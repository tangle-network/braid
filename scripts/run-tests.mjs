...
const scopeFiles = {
  unit: [
    'application.test.js',
    'bound-memory-adversarial.test.js',
    'cancellation-race-adversarial.test.js',
    'command-parity-adversarial.test.js',
  ...
  rpc: ['jsonl-malformed-adversarial.test.js', 'rpc.test.js', 'w6-contract.test.js'],
