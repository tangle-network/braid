...
const windowsMonitorScript = [
  ...
  "if ($event.SourceIdentifier -eq $startId) { [Console]::Out.WriteLine(('S,{0},{1},{2}' -f $record.ProcessID,$record.ParentProcessID,$record.TIME_CREATED)) }",
  "elseif ($event.SourceIdentifier -eq $stopId) { [Console]::Out.WriteLine(('X,{0},{1}' -f $record.ProcessID,$record.TIME_CREATED)) }",
  '[Console]::Out.Flush()',
