...
const HEADLESS_CAPABILITIES: Readonly<Partial<Record<HeadlessCommandName, string>>> = Object.freeze(
  {
    ...
    cancel_interaction: 'interaction.respond',
    automation_create: 'interaction.automation',
    automation_update: 'interaction.automation',
    automation_dry_run: 'interaction.automation',
    automation_disable: 'interaction.automation',
    automation_delete: 'interaction.automation',
    automation_list: 'interaction.automation',
    ...
    refresh_supervision: 'supervisor.refresh',
    steer_worker: 'supervisor.worker.steer',
    cancel_worker: 'supervisor.worker.cancel',
    cancel_supervisor: 'supervisor.cancel',
    attach_worker: 'supervisor.worker.attach',
