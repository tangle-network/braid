...
/** Complete pending requests are never evicted. Reject overflow instead of losing answer data. */
export const MAX_PENDING_RUN_INTERACTIONS = 1_024
export const MAX_RUN_INTERACTION_IDENTITIES = 4_096
