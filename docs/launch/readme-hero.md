...
- The same profile ran through Pi and through Codex and kept its provider session across a Braid restart ([Pi](artifacts/verification/live-core/pi.json), [Codex](artifacts/verification/live-core/codex.json)).
...
- The first three proofs predate 0.3.0: 2026-08-15, 2026-09-01, and 2026-08-09.
